...
from src.detection.detector import SignalDetector, create_default_detector_daily, create_default_detector_min15
...
def get_daily_detector() -> SignalDetector:
    """
    获取默认的日K检测器（MA5/MA20 金叉）

    Returns:
        SignalDetector 实例
    """
    import config
    return create_default_detector_daily(
